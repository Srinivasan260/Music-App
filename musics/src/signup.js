...
import signup from './settings/sigm2.png'
            ...
            <Form>
              <div id="signup-input">
                ...
                <Form.Group className="mb-1" as={Col} md="11" controlId="formBasicEmail">
                  ...
                  <Form.Control type=" phonenumber" placeholder="Enter phnnumber" value={Phn} onChange={(e) => { setPhn(e.target.value) }} />
                ...
                <Form.Group className="mb-1" as={Col} md="11" controlId="formBasicPassword">
                  ...
                  <Form.Control type="password" placeholder=" Enter Password" value={password} onChange={(e) => { setPsw(e.target.value) }} />
